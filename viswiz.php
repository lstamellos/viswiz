                ...
                <?php if ( $active_tab === 'sales' ) : ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">Defines the default time window for WooCommerce sales queries. Example: <code>period_days="30"</code>.</p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">Used for category-scope charts. Example: <code>category_id="45"</code>.</p>
                        </td>
                    </tr>
                    <tr>
